...
export default function TaskList() {
    ...
    const toggleTask = async (taskId) => {
        ...
        try {
            const response = await axios.put(`https://683e28c31cd60dca33da9796.mockapi.io/tasks/${taskUpdate.id}`, taskUpdate)
        } catch (error) {
    ...
    const addTask = async newTask => {
        ...
        try {
            const response = await axios.post('https://683e28c31cd60dca33da9796.mockapi.io/tasks', taskAdd)
        } catch (error) {
    ...
    const deleteTask = async id => {
        ...
        try {
            const response = await axios.delete(`https://683e28c31cd60dca33da9796.mockapi.io/tasks/${id}`)
        } catch (error) {
